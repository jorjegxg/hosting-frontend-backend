...
export const metadata: Metadata = {
  title: "Managed Website Deployment Service",
  description:
    "Managed website deployment service with domain connection, SSL setup, launch validation, and support.",
      ...
      <section className="border-b border-indigo-100 bg-white">
        <div className="mx-auto w-full max-w-5xl px-6 py-16">
          ...
          <h1 className="mt-3 text-3xl font-bold text-indigo-950 sm:text-5xl">
            Managed website deployment with clear delivery workflow
          </h1>
